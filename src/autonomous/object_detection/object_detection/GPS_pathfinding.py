...
class GPSIMUPathfinding(Node):
    def __init__(self):
        ...
        # --- Parameters ---
        self.declare_parameter('speed', 0.5)         # Base speed
        self.declare_parameter('turn_gain', 2.0)     # Higher gain because IMU is responsive
        ...
        # 3. Targets
        self.create_subscription(NavSatFix, '/GPS/decimal_target', self.decimal_target_callback, 10)
        self.create_subscription(PointStamped, '/GPS/map_target', self.map_target_callback, 10)
        ...
        self.get_logger().info("GPS + IMU Node Started. Point robot NORTH before starting!")
