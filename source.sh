...
export PYTHON_INCLUDE_DIR=$(python3.10 -c "import sysconfig; print(sysconfig.get_path('include'))")
export PYTHON_LIBRARY=$(python3.10 -c "import sysconfig; print(sysconfig.get_config_var('LIBDIR'))")
